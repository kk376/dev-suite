...
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("~/.config/ml4w/scripts/ml4w-cliphist"), { description = "Open clipboard manager" })
...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("codium"), { description = "Open VS Codium" })
